 ...
 * числами (типа int). Каждый из регионов имеет размер 1000 байт. Требуется
 * разработать приложение, которое попарно суммирует первые 100 чисел в этих
 * регионах и помещает суммы в новый (созданный приложением) регион памяти
 * размером 1000 байт. Таким образом, после завершения работы приложения в
 ...
 * символом конца строки. На вход приложение принимает ключи существующих
 * регионов памяти.
 */
